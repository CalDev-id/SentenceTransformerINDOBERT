...
#         self.validation_dataset_path = "datasets/github/github_validation.json"
#         self.test_dataset_path = "datasets/github/github_test.json"
#         self.processed_dataset_path = "datasets/manual_processed.csv"
...
#         def gabungquerycorpus(query, corpus):
#             return query + ' ' + corpus
